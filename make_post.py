...
def generate_section(cfg: dict)-> None:
    ...
    for section in sections:
        ...
        for phrase in ["bash", "typescript", "javascript", "java", "makefile", "dotnet","python", "less", "scss",  "css",  "sql", "ruby", "rust", "php"]:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--file', type=str, default='books/powershell/intro_to_powershell.yml')
